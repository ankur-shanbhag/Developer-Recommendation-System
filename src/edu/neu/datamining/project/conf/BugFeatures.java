...
/**
 * This class holds information about the features being used in for building
 * the recommendation system
 * 
 * @author Ankur Shanbhag
 *
 */
public final class BugFeatures {
	...
	static {
		...
		INDEX_FEATURE_MAPPING.put(IDX_OPERATING_SYSTEMS_ALL,
				OPERATING_SYSTEMS_ALL);
		INDEX_FEATURE_MAPPING.put(IDX_OPERATING_SYSTEMS_OTHERS,
				OPERATING_SYSTEMS_OTHERS);
		INDEX_FEATURE_MAPPING.put(IDX_OPERATING_SYSTEMS_MAC,
				OPERATING_SYSTEMS_MAC);
		INDEX_FEATURE_MAPPING.put(IDX_OPERATING_SYSTEMS_WINDOWS,
				OPERATING_SYSTEMS_WINDOWS);
		INDEX_FEATURE_MAPPING.put(IDX_OPERATING_SYSTEMS_LINUX,
		...
		INDEX_FEATURE_MAPPING.put(IDX_COMPONENT_CDT_PARSER,
				COMPONENT_CDT_PARSER);
		...
		INDEX_FEATURE_MAPPING.put(IDX_COMPONENT_USER_ASSITANCE,
				COMPONENT_USER_ASSITANCE);
		...
		INDEX_FEATURE_MAPPING.put(IDX_COMPONENT_DEPRECATED7,
				COMPONENT_DEPRECATED7);
	}
